...
namespace GPXManager.entities
{
    public class USBEject
    {
        ...
        //public IntPtr USBEject1(string driveLetter)
        //{
        ...
        {
            return CreateFile(_fileName, GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, IntPtr.Zero, 0x3, 0, IntPtr.Zero);
        }
        public  USBEject(string driveLetter)
        {
            _fileName = @"\\.\" + driveLetter[0] + ":";
            //
        }
